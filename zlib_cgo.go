...
#cgo linux CFLAGS: -DHAVE_BUILTIN_CTZL -DHAVE_VISIBILITY_HIDDEN -DHAVE_VISIBILITY_INTERNAL -DUNALIGNED_OK -DX86_CPUID -DX86_QUICK_STRATEGY -DX86_SSE2 -DX86_SSE42_CRC_HASH -DX86_SSE42_CRC_INTRIN -D_LARGEFILE64_SOURCE=1 -D__USE_LARGEFILE64 -Wall  -msse4 -I.

#cgo darwin CFLAGS: -DHAVE_BUILTIN_CTZL -DHAVE_VISIBILITY_HIDDEN -DHAVE_VISIBILITY_INTERNAL -DUNALIGNED_OK -DX86_CPUID -DX86_QUICK_STRATEGY -DX86_SSE2 -DX86_SSE42_CRC_HASH -DX86_SSE42_CRC_INTRIN -D__USE_LARGEFILE64 -Wall  -msse4 -I.
